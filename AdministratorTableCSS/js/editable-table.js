    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[6].innerHTML = '<a class="edit" href="">Edit Order</a>';
                jqTds[7].innerHTML = '<a class="cancel" href="">Cancel Order</a>';
            }
            ...
            function cancelEditRow(oTable, nRow) {
                ...
                oTable.fnUpdate(jqInputs[4].value, nRow, 4, false);
                oTable.fnUpdate(jqInputs[5].value, nRow, 5, false);
                oTable.fnUpdate('<a class="edit" href="">Edit Order</a>', nRow, 6, false);
                oTable.fnDraw();
            }
